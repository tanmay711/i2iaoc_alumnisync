...
def export_alumni(
    ...
    writer.writerow([
        ...
        "start_year", "end_year", "bio", "current_company", "current_title",
        "current_industry", "location", "profile_url",
        "past_companies", "past_titles", "skills", "projects", "certifications",
    ...
    for a in alumni_list:
        ...
        writer.writerow([
            ...
            a.start_year, a.end_year, a.bio, a.current_company, a.current_title,
            a.current_industry, a.location, a.profile_url, a.past_companies,
            a.past_titles, csv_value(a.skills), csv_value(a.projects), csv_value(a.certifications),
